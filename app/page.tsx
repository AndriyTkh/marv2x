...
export const metadata: Metadata = {
  title: 'Marvilon | Integrated Optical Measuring Systems for Industrial Emissions',
  description:
    'Marvilon develops advanced optical measurement solutions for simultaneous combined monitoring for wet gases, dust, and moisture in real time, incuding hazardous industrial environments.',
  keywords: [
